...
var LivechatClient = /** @class */ (function (_super) {
    ...
    LivechatClient.prototype.notifyVisitorTyping = function (rid, username, typing, text) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.socket];
                    case 1: return [2 /*return*/, (_a.sent()).notifyVisitorTyping(rid, username, typing, this.credentials.token, text)];
                }
            });
        });
    };
