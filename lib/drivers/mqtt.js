...
var MQTTDriver = /** @class */ (function (_super) {
    ...
    function MQTTDriver(_a) {
        ...
        _this.config = __assign(__assign(__assign({}, config), moreConfigs), { host: _host.replace(/^http/, 'ws'), timeout: 20000, port: port });
        _this.logger = logger;
        if (/https/.test(host)) {
    ...
    MQTTDriver.prototype.notifyVisitorTyping = function (rid, username, typing, token, text) {
        return Promise.resolve();
    };
