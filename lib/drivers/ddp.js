        ...
        _this.send = function (obj) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        _this.sent += 1;
                        var data = __assign(__assign({}, obj), (/connect|ping|pong/.test(obj.msg) ? {} : { id: id }));
                        ...
                        _this.once(listener, function (result) {
                            ...
                            return (result.error ? reject(result.error) : resolve(__assign(__assign({}, (/connect|ping|pong/.test(obj.msg) ? {} : { id: id })), result)));
                        });
                    })];
            });
        }); };
...
var DDPDriver = /** @class */ (function (_super) {
    ...
    function DDPDriver(_a) {
        ...
        _this.connect = function (c) {
            ...
            var config = __assign(__assign({}, _this.config), c); // override defaults
        ...
        _this.notifyVisitorTyping = function (rid, username, typing, token, text) {
            return _this.ddp.call('stream-notify-room', rid + "/typing", username, typing, { token: token, text: text });
        };
        ...
        _this.config = __assign(__assign(__assign({}, config), moreConfigs), { host: host.replace(/(^\w+:|^)\/\//, ''), timeout: 20000 });
        _this.ddp = new Socket(__assign(__assign({}, _this.config), { logger: logger }));
        _this.logger = logger;
        return _this;
    }
