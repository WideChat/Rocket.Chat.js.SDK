...
var ApiLivechat = /** @class */ (function (_super) {
    ...
    ApiLivechat.prototype.sendMessage = function (message) { return (this.post('livechat/message', __assign(__assign({}, message), { token: this.credentials.token }), false)); };
    ...
    ApiLivechat.prototype.loadMessages = function (rid, params) {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this.get("livechat/messages.history/" + rid, __assign(__assign({}, params), { token: this.credentials.token }), false)];
